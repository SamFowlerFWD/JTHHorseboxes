...
export const metadata: Metadata = {
  ...
  description: 'Leading British horsebox manufacturer in Norfolk. Premium 3.5 tonne horseboxes from £18,500. Professional 35, Principle 35, Progeny 35 models. Incorporating KPH heritage. Family-run business in Beeston.',
  ...
  openGraph: {
    ...
    description: 'Leading British horsebox manufacturer. Premium 3.5t, 4.5t, 7.2t & 7.5t models from £18,500. Incorporating KPH heritage. Visit our Norfolk showroom.',
    images: ['/hero.webp'],
    type: 'website',
    locale: 'en_GB',
