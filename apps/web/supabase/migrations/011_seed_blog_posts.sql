-- Migration: Seed blog posts from existing JTH website content
-- Date: 2025-01-17
-- Description: Import 7 existing blog articles from jthltd.co.uk/horsebox-advice

-- Article 1: Horsebox Payloads
INSERT INTO blog_posts (
  ...
  'Horsebox Payloads: Understanding Weight Limits and Legal Requirements',
  'horsebox-payloads',
  'A comprehensive guide to understanding horsebox payload fundamentals, weight calculations, and legal compliance for safe horse transportation.',
  '<h2>Understanding Horsebox Payloads</h2>
...
<p><em>Written by Kevin Parker, formerly of KPH. Content acquired by J Taylor Horseboxes Ltd in 2025.</em></p>',
  'Buying Guide',
  ARRAY['payload', 'weight', 'safety', 'compliance', 'legal requirements'],
  'Horsebox Payloads: Weight Limits & Legal Requirements | JTH',
  'Expert guide to horsebox payload calculations, weight limits, and legal compliance. Learn how to properly calculate payload and avoid overloading.',
  ARRAY['horsebox payload', 'weight limits', 'MAM', 'axle loading', 'horsebox weight'],
  false,
  '/blog/horsebox-payloads.jpg',
  'published',
  '2025-02-07T10:00:00Z',
  NOW(),
  NOW()
);

-- Article 2: Horsebox Ventilation
INSERT INTO blog_posts (
  title,
  slug,
  excerpt,
  ...
  'Horsebox Ventilation: Maintaining Proper Airflow and Temperature Control',
  'horsebox-ventilation',
  'Comprehensive guide to maintaining proper airflow and temperature control when transporting horses, with expert testing insights.',
...
<p><em>Written by Kevin Parker, formerly of KPH.</em></p>',
  'Safety',
  ARRAY['ventilation', 'temperature', 'horse welfare', 'airflow'],
  'Horsebox Ventilation: Temperature Control & Airflow | JTH',
  'Expert guide to horsebox ventilation with temperature monitoring, window design, and proven cooling strategies for safe horse transport.',
  ARRAY['horsebox ventilation', 'temperature control', 'horse transport safety', 'airflow'],
  true,
  '/blog/horsebox-ventilation.jpg',
  'published',
...
INSERT INTO blog_posts (
  ...
  'Horsebox Aluminium: Advantages, Limitations, and Best Practices',
  'horsebox-aluminium',
  'Expert analysis of aluminium in horsebox manufacturing, including advantages, critical limitations, and real-world case studies.',
  '<h2>The Truth About Aluminium in Horsebox Construction</h2>
...
<p><em>Written by Kevin Parker, formerly of KPH, now with J Taylor Horseboxes Ltd.</em></p>',
  'Features',
  ARRAY['aluminium', 'materials', 'construction', 'durability'],
  'Horsebox Aluminium: Pros, Cons & Best Practices | JTH',
  'Honest expert analysis of aluminium in horsebox construction, covering advantages, limitations, and real-world case studies.',
  ARRAY['horsebox aluminium', 'aluminium construction', 'materials', 'corrosion'],
  false,
  '/blog/horsebox-aluminium.jpg',
  'published',
...
-- Article 4: Horsebox Passenger Seatbelts
INSERT INTO blog_posts (
  title,
  slug,
  excerpt,
  ...
  'Horsebox Passenger Seatbelts: Legal Requirements and Installation',
  'horsebox-passenger-seatbelts',
  'Essential guide to passenger seatbelts in horseboxes, covering UK/EU legal requirements, installation limitations, and seating configurations.',
  '<h2>Understanding Horsebox Passenger Seatbelt Requirements</h2>
...
<p><em>For questions about seating options in new JTH horseboxes, contact us at 01603 552109 or sales@jthltd.co.uk</em></p>',
  'Safety',
  ARRAY['seatbelts', 'passengers', 'legal compliance', 'safety'],
  'Horsebox Passenger Seatbelts: Legal Guide | JTH',
  'Complete guide to horsebox passenger seatbelts, UK/EU legal requirements, installation rules, and seating configurations.',
  ARRAY['horsebox seatbelts', 'passenger safety', 'legal requirements', 'EU directive'],
  false,
  '/blog/horsebox-seatbelts.jpg',
  'published',
  '2025-02-07T13:00:00Z',
  NOW(),
  NOW()
);

-- Article 5: Horsebox Safety Checks
INSERT INTO blog_posts (
  title,
  slug,
  excerpt,
  ...
  'Horsebox Safety Checks: Pre-Trip Preparation Essentials',
  'horsebox-safety-checks',
  'Comprehensive pre-trip safety checklist for horsebox owners, covering documentation, payload, tires, flooring, and essential maintenance.',
  '<h2>Essential Pre-Trip Safety Checks</h2>
...
<p><em>Written by Kevin Parker, formerly of KPH, now with J Taylor Horseboxes Ltd.</em></p>',
  'Maintenance',
  ARRAY['safety', 'maintenance', 'pre-trip checks', 'inspection'],
  'Horsebox Safety Checks: Pre-Trip Essentials | JTH',
  'Essential pre-trip safety checklist covering documentation, payload, tires, flooring, and critical maintenance for horsebox owners.',
  ARRAY['horsebox safety', 'pre-trip checks', 'maintenance', 'inspection'],
  false,
  '/blog/horsebox-safety-checks.jpg',
  'published',
...
-- Article 6: Before You Buy A Horsebox
INSERT INTO blog_posts (
  title,
  slug,
  excerpt,
  ...
  'Before You Buy A Horsebox: Essential Buyer''s Guide',
  'before-you-buy-a-horsebox',
  'Comprehensive buyer''s guide covering licensing requirements, payload calculations, quality assessment, and manufacturer transparency.',
  '<h2>Critical Considerations Before Purchasing a Horsebox</h2>
...
<p><em>Written by Kevin Parker, formerly of KPH, now with J Taylor Horseboxes Ltd.</em></p>',
  'Buying Guide',
  ARRAY['buying guide', 'inspection', 'quality', 'manufacturer transparency'],
  'Before You Buy A Horsebox: Complete Buyer''s Guide | JTH',
  'Essential horsebox buyer''s guide covering licensing, payload, quality inspection, and manufacturer transparency. Make an informed purchase.',
  ARRAY['horsebox buying guide', 'horsebox inspection', 'buying checklist', 'horsebox quality'],
  true,
  '/blog/before-you-buy-horsebox.jpg',
  'published',
...
INSERT INTO blog_posts (
  ...
  'Horsebox Air Brakes: Understanding Air Brake Systems',
  'horsebox-air-brakes',
  'Comprehensive guide to air brake systems for horsebox operators, covering history, operation, safety features, and MOT testing.',
  '<h2>Understanding Air Brake Systems in Horseboxes</h2>
...
<p><em>Written by Kevin Parker, formerly of KPH.</em></p>',
  'Features',
  ARRAY['air brakes', 'safety', 'braking systems', 'heavy vehicles'],
  'Horsebox Air Brakes: Complete Guide to Air Brake Systems | JTH',
  'Expert guide to air brake systems in horseboxes, covering operation, safety features, load sensing, and MOT testing tips.',
  ARRAY['horsebox air brakes', 'air brake systems', 'ABS', 'load sensing valve'],
  false,
  '/blog/horsebox-air-brakes.jpg',
  'published',
