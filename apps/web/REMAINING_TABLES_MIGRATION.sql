...
--
-- Run this AFTER the customers migration is complete
-- =====================================================
...
CREATE TABLE leads (
    ...
    source VARCHAR(100) DEFAULT 'website', -- e.g., 'website', 'phone', 'email', 'referral', 'event'
    source_campaign VARCHAR(255), -- Specific campaign or referral
    ...
    -- Requirements
    horsebox_type VARCHAR(50), -- e.g., '3.5t', '4.5t', '7.2t'
    budget_min DECIMAL(10,2),
    budget_max DECIMAL(10,2),
    timeline VARCHAR(100), -- e.g., 'immediate', '1-3 months', '3-6 months', '6+ months'
    requirements TEXT, -- Detailed requirements from configurator or inquiry
...
CREATE TABLE quotes (
    ...
    horsebox_model VARCHAR(100) NOT NULL, -- e.g., 'JTH Professional 4.5T'
    horsebox_type VARCHAR(50) NOT NULL, -- e.g., '3.5t', '4.5t', '7.2t'
    base_price DECIMAL(12,2) NOT NULL,

    -- Configuration (from configurator)
    configuration JSONB, -- Full configurator state
    ...
    -- Validity and timing
    valid_until DATE,
    build_time_weeks INTEGER, -- Estimated build time
...
CREATE TABLE quote_items (
    ...
    category VARCHAR(100), -- e.g., 'Living Area', 'Horse Area', 'Exterior'
...
CREATE TABLE inventory (
    ...
    name VARCHAR(255) NOT NULL,
    description TEXT,
    category VARCHAR(100) NOT NULL, -- e.g., 'horsebox', 'parts', 'accessories'
    subcategory VARCHAR(100),

    -- Horsebox specific (if category = 'horsebox')
    horsebox_type VARCHAR(50), -- e.g., '3.5t', '4.5t', '7.2t'
    model VARCHAR(100),
    variant VARCHAR(100),
    ...
    -- Location
    location VARCHAR(255), -- Warehouse/yard location
    location_details VARCHAR(255), -- Bay number, etc.

    -- Pricing
    cost_price DECIMAL(10,2),
    sale_price DECIMAL(12,2) NOT NULL,
    rrp DECIMAL(12,2), -- Recommended retail price
...
CREATE TABLE inventory_movements (
    ...
    reference_type VARCHAR(50), -- e.g., 'order', 'quote', 'build'
    reference_id UUID,
    reason TEXT,
    notes TEXT,
    performed_by UUID REFERENCES profiles(id),
...
-- Leads policies (authenticated users can view/manage)
